...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / SSFM Module / Step_Size / __np_log_step__',
      functionName: '__np_log_step__',
      signature: '__np_log_step__(self, p)',
      functionDesc: '结合非线性相位限制与对数分布方法计算当前步长。先根据最大非线性相移得到参考步长，再依据链路损耗进行调整。',
      paramsTitle: '函数参数',
      params: [
