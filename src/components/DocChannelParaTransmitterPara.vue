<template>
  <div class="channel-para-transmitter-para-doc-page">
    <!-- 主内容区域 -->
    <main class="doc-main-content">
      ...
      <div class="doc-content">
        ...
        <div class="breadcrumb">
          ...
          <span class="separator">/</span>
          <span class="current">__transmitter_para__</span>
        </div>

        <!-- 5.2 页面标题（函数名） -->
        <h1 class="page-title">__transmitter_para__</h1>

        <!-- 5.3 函数签名框 -->
        <div class="function-signature">
          <span class="signature-text">__transmitter_para__(self)</span>
        ...
        <p class="section-text">
          {{ docData?.description || '当前版本不支持对发射机进行配置。' }}
        </p>
        ...
        <!-- 5.7 声明正文 -->
        <p class="section-text declaration-text">
          {{ docData?.declaration || 'NotImplementedError：当使用了发射机模块时触发：\'Transmitter is not available at now version, please shut it down\'。' }}
        </p>
...
const handleCopy = () => {
  const code = '__transmitter_para__(self)'
...
<style scoped>
.channel-para-transmitter-para-doc-page {
  width: 100%;
  min-height: 2304px;
  background: #FFFFFF;
