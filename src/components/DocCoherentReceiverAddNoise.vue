  ...
  <div class="doc-content-wrapper">
    ...
    <main class="doc-content" id="doc-content">
      ...
      <section class="doc-section" id="section-declaration">
        ...
        <p class="section-text declaration-text">{{ docData.declaration }}</p>
      </section>
    </main>
...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / coherent_receiver / __add_noise__',
      functionName: '__add_noise__',
      signature: '__add_noise__(self, x, rand_seed)',
      functionDescTitle: '函数说明',
      functionDesc: '向每一路偏振信号依次添加接收机噪声。',
      paramsTitle: '函数参数',
      params: [
        { name: 'x', format: 'list', description: '经过信道传输，输入ICR信号' },
      ...
      declarationTitle: '声明',
      declaration: "AttributeError：当 data_mode 设置值不在可选范围内触发：'ERROR: data_mode is not defined as tensor or numpy'。"
    })
  }
})
