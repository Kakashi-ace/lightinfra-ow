    ...
    <main class="doc-main-content">
      ...
      <div class="doc-content">
        ...
        <div class="breadcrumb">
          ...
          <span class="separator">/</span>
          <span class="current">nn</span>
        </div>

        <!-- 5.2 页面标题（函数名） -->
        <h1 class="page-title">nn</h1>
        ...
        <p class="section-text">
          {{ docData?.description || '使用已训练的编码器神经网络获得调制信号星座图' }}
        </p>
...
const functionSignature = "nn(encoder, condi, bits_per_sym)"

const parameters = [
  { name: 'encoder', format: 'Text', desc: '编码器神经网络模型' },
  { name: 'condi', format: 'array_like', desc: '与当前条件下光纤传输相关的神经网络输入条件' },
  { name: 'bits_per_sym', format: 'int', desc: '待调制信号的比特位数' }
]
