...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / SSFM Module / SSFM / __ssfm_scalar__',
      functionName: '__ssfm_scalar__',
      signature: '__ssfm_scalar__(self, sigin)',
      functionDesc: '执行SSFM算法求解单偏振信号传输方程。仿真传输逐步进行直至累积步长达到当前跨段长度。一次循环先计算当前步长，再更新参数并分别计算非线性及色散效应，最后加入链路衰减。',
      paramsTitle: '函数参数',
      params: [
