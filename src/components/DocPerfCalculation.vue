<template>
  <div class="perf-calculation-doc-page">
    <!-- 主内容区域 -->
    <main class="doc-main-content">
      ...
      <div class="doc-content">
        ...
        <div class="breadcrumb">
          ...
          <span>Signal</span>
          <span class="separator">/</span>
          <span class="current">perf_calculation</span>
        </div>

        <!-- 5.2 页面标题 -->
        <h1 class="page-title">perf_calculation 功能说明</h1>

        <!-- 5.3 页面副标题 -->
        <p class="page-subtitle">
          {{ docData?.subtitle || 'perf_calculation 模块提供误码率、互信息、Q 因子及符号错误率等性能指标的计算功能。' }}
        </p>
        ...
        <section :id="pageNavItems[0].id" class="doc-section">
          ...
          <p class="section-text">
            {{ docData?.description || '该模块封装了多种性能计算函数，用于评估光通信系统的传输性能。' }}
          </p>
        </section>
...
const functions = [
  { name: 'ber', desc: '计算误码率' },
  { name: 'mi', desc: '计算互信息' },
  { name: 'gmi', desc: '计算广义互信息' },
  { name: 'q_factor', desc: '计算 Q 因子' },
  { name: 'ser', desc: '计算符号错误率' },
  { name: 'ber_awgn', desc: '计算 AWGN 理论误码率' }
]
