    ...
    <main class="doc-main-content">
      ...
      <div class="doc-content">
        ...
        <div class="breadcrumb">
          ...
          <span>data_gen</span>
          <span class="separator">/</span>
          <span class="current">rng_gen</span>
        </div>

        <!-- 5.2 页面标题（函数名） -->
        <h1 class="page-title">rng_gen</h1>
        ...
        <p class="section-text">
          {{ docData?.description || '根据随机数种子和随机数生成器类型获得随机数生成器' }}
        </p>
...
const functionSignature = "rng_gen(seed = -1, random_type = 'MT19937')"
