<template>
  <div class="channel-para-receiver-para-doc-page">
    <!-- 主内容区域 -->
    <main class="doc-main-content">
      ...
      <div class="doc-content">
        ...
        <div class="breadcrumb">
          ...
          <span class="separator">/</span>
          <span class="current">__receiver_para__</span>
        </div>

        <!-- 5.2 页面标题（函数名） -->
        <h1 class="page-title">__receiver_para__</h1>

        <!-- 5.3 函数签名框 -->
        <div class="function-signature">
          <span class="signature-text">__receiver_para__(self)</span>
        ...
        <p class="section-text">
          {{ docData?.description || '检查相干接收机模块所需参数是否全部配置完成，传入参数创建ICR类对象 icr_obj。' }}
        </p>
      </div>
...
const handleCopy = () => {
  const code = '__receiver_para__(self)'
...
<style scoped>
.channel-para-receiver-para-doc-page {
  width: 100%;
  min-height: 2304px;
  background: #FFFFFF;
