...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / SSFM Module / SSFM / forward_pass',
      functionName: 'forward_pass',
      signature: 'forward_pass(self, sigin, span_len)',
      functionDesc: '包装函数。调用SSFM类对象时自动调用该方法，该方法将调用 __ssfm_matrix__ 或 __ssfm_scalar__ 执行算法。',
      paramsTitle: '函数参数',
      params: [
        { name: 'sigin', format: 'list', description: '输入该跨段的信号' },
