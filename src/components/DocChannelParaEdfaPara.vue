<template>
  <div class="channel-para-edfa-para-doc-page">
    <!-- 主内容区域 -->
    <main class="doc-main-content">
      ...
      <div class="doc-content">
        ...
        <div class="breadcrumb">
          ...
          <span class="separator">/</span>
          <span class="current">__edfa_para__</span>
        </div>

        <!-- 5.2 页面标题（函数名） -->
        <h1 class="page-title">__edfa_para__</h1>

        <!-- 5.3 函数签名框 -->
        <div class="function-signature">
          <span class="signature-text">__edfa_para__(self)</span>
        ...
        <p class="section-text">
          {{ docData?.description || '检查EDFA模块所需参数是否全部配置完成，传入参数创建EDFA类对象 edfa_obj。' }}
        </p>
      </div>
...
<style scoped>
.channel-para-edfa-para-doc-page {
  width: 100%;
  min-height: 2304px;
  background: #FFFFFF;
