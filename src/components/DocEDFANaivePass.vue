...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / EDFA / __naive_pass__',
      functionName: '__naive_pass__',
      signature: '__naive_pass__(self, sigin, rand_seed)',
      functionDescTitle: '函数说明',
      functionDesc: '信号经过有噪声 EDFA：先进行信号放大，再添加 ASE 噪声。',
      paramsTitle: '函数参数',
      params: [
