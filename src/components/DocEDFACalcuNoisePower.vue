...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / EDFA / __calcu_noise_power__',
      functionName: '__calcu_noise_power__',
      signature: '__calcu_noise_power__(self)',
      functionDescTitle: '函数说明',
      functionDesc: '计算 ASE 噪声功率。计算公式见 EDFA 类的背景信息介绍。'
    })
  }
})
