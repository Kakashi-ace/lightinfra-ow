...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / coherent_receiver / __naive_pass__',
      functionName: '__naive_pass__',
      signature: '__naive_pass__(self, x, rand_seed)',
      functionDescTitle: '函数说明',
      functionDesc: "信号通过ICR模块，由 forward_pass 调用，对应ICR模式参数 mode = 'naive'。",
      paramsTitle: '函数参数',
      params: [
