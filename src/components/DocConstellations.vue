<template>
  <div class="constellations-doc-page">
    <!-- 主内容区域 -->
    <main class="doc-main-content">
      ...
      <div class="doc-content">
        ...
        <div class="breadcrumb">
          ...
          <span>Signal</span>
          <span class="separator">/</span>
          <span class="current">constellations</span>
        </div>

        <!-- 5.2 页面标题 -->
        <h1 class="page-title">constellations 功能说明</h1>

        <!-- 5.3 页面副标题 -->
        <p class="page-subtitle">
          {{ docData?.subtitle || 'constellations 模块提供 QAM 星座图生成及几何整形星座映射功能。' }}
        </p>
        ...
        <section :id="pageNavItems[0].id" class="doc-section">
          ...
          <p class="section-text">
            {{ docData?.description || '该模块封装了标准 QAM 星座映射和几何整形星座映射函数，用于生成发射端符号。' }}
          </p>
        </section>
...
const functions = [
  { name: 'qammap', desc: '生成 QAM 星座映射' },
  { name: 'gs_qammap', desc: '生成几何整形 QAM 星座映射' }
]
