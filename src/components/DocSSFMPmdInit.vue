...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / SSFM Module / SSFM / __pmd_init__',
      functionName: '__pmd_init__',
      signature: '__pmd_init__(self)',
      functionDesc: '配置PMD效应仿真参数，包括随机双折射分段、差分群延迟以及偏振耦合计算所需参数。',
      paramsTitle: '函数参数',
      paramsDesc: '本函数无传入参数。',
      returnTitle: '返回',
      returnDesc: '本函数无返回值。'
