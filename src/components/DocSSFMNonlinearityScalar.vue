...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / SSFM Module / SSFM calculation functions / nonlinearity_scalar',
      functionName: 'nonlinearity_scalar',
      signature: 'nonlinearity_scalar(sigin, nl_gamma, dz, data_mode=\'numpy\')',
      functionDesc: '计算单偏振信号传输过程的非线性效应。具体计算原理公式见 SSFM 类背景信息介绍。',
      paramsTitle: '函数参数',
      params: [
