...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / SSFM Module / Step_Size / step',
      functionName: 'step',
      signature: 'step(self, p)',
      functionDesc: '计算当前单步步长。调用 Step_Size 类对象时自动调用，并根据 dz_mode 选择恒定步长、对数分布、非线性相位旋转或组合方法。',
      paramsTitle: '函数参数',
      params: [
