...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / SSFM Module / Step_Size / __log_step__',
      functionName: '__log_step__',
      signature: '__log_step__(self)',
      functionDesc: '使用对数分布方法计算当前步长。该方法根据链路损耗和当前累积传播距离分配步长，以抑制SSFM仿真中的伪四波混频效应。',
      paramsTitle: '函数参数',
      paramsNote: '本函数无传入参数。',
      returnTitle: '返回',
      returnParam: {
