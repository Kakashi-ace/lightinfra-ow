...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / EDFA / __amplifier__',
      functionName: '__amplifier__',
      signature: '__amplifier__(self, sigin)',
      functionDescTitle: '函数说明',
      functionDesc: '按照设定的 EDFA 增益放大输入信号。',
      paramsTitle: '函数参数',
      params: [
