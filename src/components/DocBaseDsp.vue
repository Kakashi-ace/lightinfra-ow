    ...
    <main class="doc-main-content">
      ...
      <div class="doc-content">
        ...
        <div class="breadcrumb">
          ...
          <span class="separator">/</span>
          <span class="current">base_dsp</span>
        </div>

        <!-- 5.2 页面标题 -->
        <h1 class="page-title">base_dsp 类说明</h1>

        <!-- 5.3 页面副标题 -->
        <p class="page-subtitle">
          {{ docData?.subtitle || 'base_dsp 是 IFTS 仿真工具中的基础数字信号处理类，负责数据格式转换、属性检查等核心功能。' }}
        </p>
        ...
        <section :id="pageNavItems[0].id" class="doc-section">
          ...
          <p class="section-text">
            {{ docData?.classDesc || '该类提供了数字信号处理的基础功能，包括数据模式转换、属性获取与校验等方法。' }}
          </p>
        </section>
