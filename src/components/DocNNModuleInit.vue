...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / NN Module / __init__',
      functionName: '__init__',
      functionDesc: '初始化 NN 类，建立跨段神经网络传输所需的基础参数与运行环境。',
      callTitle: '调用方式',
      signature: '__init__(self, para=None, **kwargs)',
      paramsTitle: '参数',
      params: [
        { name: 'para', format: 'dict，可选', description: 'NN 模块的初始化参数配置' },
        { name: '**kwargs', format: '任意', description: '其他可选配置参数' }
      ],
      returnTitle: '返回值',
      returnParam: {
        name: 'None',
