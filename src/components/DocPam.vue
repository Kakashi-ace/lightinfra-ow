    ...
    <main class="doc-main-content">
      ...
      <div class="doc-content">
        ...
        <div class="breadcrumb">
          ...
          <span class="separator">/</span>
          <span class="current">pam</span>
        </div>

        <!-- 5.2 页面标题（函数名） -->
        <h1 class="page-title">pam</h1>
        ...
        <p class="section-text">
          {{ docData?.description || '根据比特位数，获得脉冲振幅调制(PAM)信号星座图' }}
        </p>
...
const functionSignature = "pam(M, mode = 'single', codemode = 'gray')"

const parameters = [
  { name: 'M', format: 'int', desc: '待调制信号的比特位数' },
  { name: 'mode', format: 'str, optional', desc: '调制模式（单极性或双极性）' },
  { name: 'codemode', format: 'str, optional', desc: '编码模式（自然二进制编码或格雷编码）' }
]
