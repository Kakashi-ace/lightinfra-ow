...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / SSFM Module / SSFM / __step_init__',
      functionName: '__step_init__',
      signature: '__step_init__(self)',
      functionDesc: '配置算法执行过程中的步长计算参数，并创建用于计算当前步长的 Step_Size 类对象。',
      paramsTitle: '函数参数',
      paramsDesc: '本函数无传入参数。',
      returnTitle: '返回',
      returnDesc: '本函数无返回值。'
