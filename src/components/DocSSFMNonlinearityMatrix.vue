...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / SSFM Module / SSFM calculation functions / nonlinearity_matrix',
      functionName: 'nonlinearity_matrix',
      signature: 'nonlinearity_matrix(sigin, nl_gamma, dz, Manakov=1, data_mode=\'numpy\')',
      functionDesc: '计算双偏振信号传输过程的非线性效应。可选择求解Manakov方程或CNLSE方程来计算非线性效应，具体计算原理见SSFM类背景信息介绍。',
      paramsTitle: '函数参数',
      params: [
        { name: 'sigin', format: 'list', description: '传输的信号' },
        { name: 'nl_gamma', format: 'float', description: '非线性系数' },
        { name: 'dz', format: 'float', description: '本次计算的非线性效应有效作用距离，单位km' },
        { name: 'Manakov', format: 'int，可选', description: '设定是否求解Manakov方程计算非线性作用，默认为1' },
