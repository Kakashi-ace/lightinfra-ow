...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / EDFA / __no_noise_pass__',
      functionName: '__no_noise_pass__',
      signature: '__no_noise_pass__(self, sigin)',
      functionDescTitle: '函数说明',
      functionDesc: '信号经无噪声 EDFA，仅放大，不加 ASE 噪声。',
      paramsTitle: '函数参数',
      params: [
