...
const props = defineProps({
  docData: {
    type: Object,
    default: () => ({
      breadcrumb: '资源 / 文档 / IFTS / 代码说明文档 / Channel / SSFM Module / SSFM calculation functions / linearity_scalar',
      functionName: 'linearity_scalar',
      signature: 'linearity_scalar(sigin, dz, phase_factor_freq, data_mode=\'numpy\')',
      functionDesc: '计算单偏振信号传输过程中产生的色散效应，即群速度色散。计算在频域进行，具体计算原理见 SSFM 类背景信息介绍。',
      paramsTitle: '函数参数',
      params: [
        { name: 'sigin', format: 'list', description: '传输的信号' },
