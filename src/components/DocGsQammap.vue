    ...
    <main class="doc-main-content">
      ...
      <div class="doc-content">
        ...
        <div class="breadcrumb">
          ...
          <span class="separator">/</span>
          <span class="current">gs_qammap</span>
        </div>

        <!-- 5.2 页面标题（函数名） -->
        <h1 class="page-title">gs_qammap</h1>
        ...
        <p class="section-text">
          {{ docData?.description || '根据比特位数，获得相对于调制阶数的几何整形星座图' }}
        </p>
...
const functionSignature = "gs_qammap(M)"

const parameters = [
  { name: 'M', format: 'int', desc: '比特位数' }
]
